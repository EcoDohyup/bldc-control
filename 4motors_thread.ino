...
// Task functions for each motor
void Motor1Task(void * parameter) {
  int speed = BLDC_Center;  // Initialize with center speed
  xQueueSend(motor1Queue, &speed, 0);  // Send initial speed
...
void Motor2Task(void * parameter) {
  int speed = BLDC_Center;  // Initialize with center speed
  xQueueSend(motor2Queue, &speed, 0);  // Send initial speed
...
void Motor3Task(void * parameter) {
  int speed = BLDC_Center;  // Initialize with center speed
  xQueueSend(motor3Queue, &speed, 0);  // Send initial speed
...
void Motor4Task(void * parameter) {
  int speed = BLDC_Center;  // Initialize with center speed
  xQueueSend(motor4Queue, &speed, 0);  // Send initial speed
...
void setup() {
  ...
  Serial.println("Commands: 'MOTORn speed' where n is 1-4");
  Serial.println("Speed range: 1060-1860");
  Serial.println("Example: MOTOR1 1600");

  // Create tasks for all motors
